...
export const players: Player[] = [
  {
    id: 'tshiamo-molwatse',
    name: 'Tshiamo Molwatse',
    number: 1,
    position: 'Goalkeeper',
    image: 'players/tshiamo.jpeg',
  ...
  {
    id: 'trevor-molokomme',
    name: 'Trevor Molokomme',
    number: 9,
    position: 'Midfielder',
    image: 'players/trevor.jpeg',
    nationality: 'South Africa',
    // age: 22,
